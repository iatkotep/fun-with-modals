...
# Modal Component
Modal Component relies upon a custom Hook to allocate state, and use that state in a component the Hook generates.
...
```
#### Parameters
- `isOpenInit`: `boolean` (optional) - defaults to `false`
